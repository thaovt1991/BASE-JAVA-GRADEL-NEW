...
/** The persistent class for the NYUSYUKIN_HIST database table. */
@Entity
@Table(name = "NYUSYUKIN_HIST")
@NamedQuery(name = "NyusyukinHist.findAll", query = "SELECT n FROM NyusyukinHist n")
public class NyusyukinHist implements Serializable {
  private static final long serialVersionUID = 1L;

  @EmbeddedId private NyusyukinHistPK id;
  ...
  public NyusyukinHist() {}

  public NyusyukinHistPK getId() {
    return this.id;
  }

  public void setId(NyusyukinHistPK id) {
    this.id = id;
  }
