...
/** The primary key class for the ACC_DEL_APPLICATION_INFO database table. */
@Embeddable
public class AccDelApplicationInfoPK implements Serializable {
  ...
  public AccDelApplicationInfoPK() {}
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof AccDelApplicationInfoPK)) {
      return false;
    }
    AccDelApplicationInfoPK castOther = (AccDelApplicationInfoPK) other;
