...
/** The primary key class for the LOGIN_MIL database table. */
@Embeddable
public class LoginMilPK implements Serializable {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof LoginMilPK)) {
      return false;
    }
    LoginMilPK castOther = (LoginMilPK) other;
