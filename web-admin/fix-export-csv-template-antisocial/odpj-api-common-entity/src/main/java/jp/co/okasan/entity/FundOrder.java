...
/** The persistent class for the FUND_ORDER database table. */
@Entity
@Table(name = "FUND_ORDER")
@NamedQuery(name = "FundOrder.findAll", query = "SELECT f FROM FundOrder f")
public class FundOrder implements Serializable {
  ...
  @Column(name = "`INV_SEC_CLASS_K BN`")
  private int invSecClassK_bn;
  ...
  public int getInvSecClassK_bn() {
    return this.invSecClassK_bn;
  }

  public void setInvSecClassK_bn(int invSecClassK_bn) {
    this.invSecClassK_bn = invSecClassK_bn;
  }
