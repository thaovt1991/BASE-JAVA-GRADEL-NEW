...
import jp.co.okasan.mapper.AccountLockMapperImpl;
import jp.co.okasan.mapper.AccountLockToHistory;
import jp.co.okasan.mapper.AccountLockToHistoryImpl;
...
public class AccountLockServiceImpl implements AccountLockService {
    ...
    public MessageDetail updateLockInfo(@NonNull UpdateLockInfoRequest request) {
        try {
            ...
            mapper = new AccountLockMapperImpl();
            mapperToHistory = new AccountLockToHistoryImpl();
