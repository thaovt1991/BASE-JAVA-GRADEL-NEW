...
/** The primary key class for the IMMIGRATION_CTL database table. */
@Embeddable
public class ImmigrationCtlPK implements Serializable {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof ImmigrationCtlPK)) {
      return false;
    }
    ImmigrationCtlPK castOther = (ImmigrationCtlPK) other;
