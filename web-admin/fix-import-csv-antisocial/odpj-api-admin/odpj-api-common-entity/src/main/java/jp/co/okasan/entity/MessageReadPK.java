...
/** The primary key class for the MESSAGE_READ database table. */
@Embeddable
public class MessageReadPK implements Serializable {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof MessageReadPK)) {
      return false;
    }
    MessageReadPK castOther = (MessageReadPK) other;
