...
/** The persistent class for the CLIENT_UPDATE_INFO database table. */
@Entity
@Table(name = "CLIENT_UPDATE_INFO")
@NamedQuery(name = "ClientUpdateInfo.findAll", query = "SELECT c FROM ClientUpdateInfo c")
