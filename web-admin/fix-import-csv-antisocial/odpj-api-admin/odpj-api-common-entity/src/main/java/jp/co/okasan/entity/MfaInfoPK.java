...
/** The primary key class for the MFA_INFO database table. */
@Embeddable
public class MfaInfoPK implements Serializable {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof MfaInfoPK)) {
      return false;
    }
    MfaInfoPK castOther = (MfaInfoPK) other;
