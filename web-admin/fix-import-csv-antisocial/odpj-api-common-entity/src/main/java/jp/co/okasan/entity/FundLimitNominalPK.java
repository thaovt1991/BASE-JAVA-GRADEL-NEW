...
/** The primary key class for the FUND_LIMIT_NOMINAL database table. */
@Embeddable
public class FundLimitNominalPK implements Serializable {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof FundLimitNominalPK)) {
      return false;
    }
    FundLimitNominalPK castOther = (FundLimitNominalPK) other;
